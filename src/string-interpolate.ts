 ...
 * @param {Record<string, string>} data An object containing key-value pairs, where each key corresponds to a placeholder in the input string and its value is used to replace the placeholder.
